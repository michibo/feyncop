...
class Graph(object):
    ...
    def adj_edges( self, vtx, sub_edges ):
        is_adj = lambda (x,y) : (x == vtx) or (y == vtx)
    ...
    # Returns counter of edge degree indexed by vertex tuples representing edges.
    ...
    def is_connected_sub_edges( self, sub_edges, vtcs_set=None ):
        if not sub_edges:
